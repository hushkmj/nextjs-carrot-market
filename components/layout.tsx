    ...
    return (
        <div>
            <div className={cls(
                ...
                "bg-white w-full max-w-xl text-lg font-medium px-10 py-2 fixed text-gray-800 border-b top-0 flex items-center ")}>
                {canGoBack ? (
            ...
            {hasTabBar ? (
                <nav
                    className="bg-white max-w-xl text-gray-800 border-t fixed bottom-0 px-10 pb-3 pt-3 flex justify-between w-full text-xs"
                >
