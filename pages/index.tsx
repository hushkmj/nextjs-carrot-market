...
const Home: NextPage = () => {
  return (
    <div className="bg-slate-400 dark xl:place-content-center py-20 px-20 
      grid gap-10 
      lg:grid-cols-2
      xl:grid-cols-3 
      min-h-screen">
      ...
      <div className="bg-white overflow-hidden rounded-3xl shadow-xl group">
        <div className="portrait:bg-indigo-600 landscape:bg-teal-500 p-5 pb-14 xl:pb-40">
          <span className="text-white text-xl">Profile</span>
        </div>
        <div className="rounded-3xl p-6 bg-white relative -top-5">
          <div className="flex relative -top-10 items-end justify-between">
            <div className="flex flex-col items-center">
              <span className="text-sm text-gray-500">Orders</span>
              <span className="font-medium">340</span>
            </div>
            <div className="h-16 w-16 bg-gray-300 rounded-full group-hover:bg-red-200 transition-colors" />
            <div className="flex flex-col items-center">
          ...
          <div className="relative flex flex-col items-center -mt-10 -mb-8">
            <span className="text-base font-medium">Tony Molloy</span>
